...
namespace Bảo_đạm_chất_lượng_phần_mềm
{
    ...
    public class CapNhatSanPham
    {
        ...
        public void CNSP_06()
        {
            ...
            Assert.IsTrue(webDriver.FindElement(By.XPath("/html/body/div/div/div/form/div/div/div/div[5]/div/span")).Text.Equals("The field DonGia must be between 0 and 2147483647."));
        ...
        public void CNSP_09()
        {
            ...
            Assert.IsTrue(webDriver.FindElement(By.XPath("/html/body/div/div/div/form/div/div/div/div[7]/div/span")).Text.Equals("The field SoLuong must be between 0 and 2147483647."));
