...
namespace Bảo_đạm_chất_lượng_phần_mềm
{
    ...
    public class ThemSanPham
    {
        ...
        public void TSP_06()
        {
            ...
            Assert.IsTrue(webDriver.FindElement(By.XPath("/html/body/div/div/div/form/div[2]/div/div/div[5]/div/span")).Text.Equals("The field DonGia must be between 0 and 2147483647."));
        ...
        public void TSP_09()
        {
            ...
            Assert.IsTrue(webDriver.FindElement(By.XPath("/html/body/div/div/div/form/div[2]/div/div/div[7]/div/span")).Text.Equals("The field SoLuong must be between 0 and 2147483647."));
        ...
        public void TSP_10()
        {
            ...
            webDriver.Manage().Window.Maximize();
            Thread.Sleep(waitingTime);
            webDriver.FindElement(By.Name("TenMH")).SendKeys("Macbook");
            Thread.Sleep(waitingTime);
            webDriver.FindElement(By.Id("IDLoaiMH")).Click();
            {
                var dropdown = webDriver.FindElement(By.Id("IDLoaiMH"));
